...
public class PlayerHealthHandler : MonoBehaviour, IPossessionSensitive
{
    ...
    public void OnUnPossessed(Parasite playerParasite) //when player possesses possessable
    {
        _health.ResetHealth();
    }
}
